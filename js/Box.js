/* This code is registering a new A-Frame component called "move-box" 
that defines a schema with a
default value of 1 for the property "moveX". 
It also defines a "tick" function that will be executed
every frame, which increases the value of "moveX" by 0.01
 and updates the position of the element
accordingly. */
...
AFRAME.registerComponent("move-box", {
  ...
  /* `tick: function () {` is defining a function that will be executed every frame. In this specific
  code, the tick function is increasing the value of `moveX` by 0.01 and updating the position of the
  element accordingly. */
  tick: function () {
